...
const brandStats = [
  ...
  { value: "1,000+", label: "Peer-driven interactions per campaign" },
  { value: "7", label: "Days to launch campus sales" },
];
...
const processSteps = [
  {
    ...
    desc: "Submit your product and campaign details through our onboarding form.",
  },
  {
    icon: UserPlus,
    title: "Campaign Activation",
    desc: "We recruit and assign student sales agents and campus ambassadors based on your target schools.",
  },
  {
    icon: Radio,
    title: "Campus Sales Go Live",
    desc: "Your campaign launches across selected campuses with WhatsApp-first content and referral tracking.",
  },
  {
    icon: TrendingUp,
    title: "Track Sales & Scale",
    desc: "Monitor performance by campus and agent. Scale into more schools as demand grows.",
  },
];
