...
import { Link2, Filter, Search, PackageOpen, Loader2, Eye, ShoppingCart, Store, Check, ExternalLink } from "lucide-react";
                  ...
                  <CardContent className="p-4 space-y-2.5">
                    ...
                    <div className="flex items-center justify-between gap-1.5 pt-1">
                      ...
                      <div className="flex gap-1">
                        {isLead ? (
                          <Button size="sm" className="volt-gradient text-xs h-8 px-3 shadow-md hover:shadow-lg transition-shadow" onClick={(e) => { e.preventDefault(); e.stopPropagation(); }}>
